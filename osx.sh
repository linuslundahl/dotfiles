...
# sudo scutil --set ComputerName "Linus Lundahl"
# sudo scutil --set HostName "Linus Lundahl"
# sudo scutil --set LocalHostName "Linus Lundahl"
# sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Linus-Lundahl"
